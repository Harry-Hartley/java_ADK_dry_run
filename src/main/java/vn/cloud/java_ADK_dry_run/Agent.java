...
public class Agent {
    ...
    public static void main(String[] args) {
        ...
        LlmAgent llmAgent = LlmAgent.builder()
                ...
                .instruction("""
                You are a cybersecurity assistant specialised in helping security analysts triage and analyse security incidents.
                Your primary function is to help identify the type of incident, its potential impact, and provide a clear, actionable initial response plan.
                
                When a user provides information about an incident, you should:
                1. Classify the incident type (e.g., malware, phishing, denial of service, unauthorised access).
                2. Summarise the key details of the event in a concise manner.
